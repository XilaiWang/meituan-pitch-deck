...
**「明信片」是一个寄生在美团 App 内的 AI 居家养老管家。** 它专门服务一种被忽视的家庭场景：**爸妈空巢、生活能自理、但子女在远方不放心。**

### 核心问题

中国 3.23 亿 60 岁以上人口中，约 90% 处于生活自理阶段。他们不需要保姆，不需要养老院——但子女在几百公里外，不知道她今天吃了吗、药吃了吗、家里冷不冷。**请保姆太贵、太早、不划算；什么都不做，心里又放不下。**

### 明信片做了什么

| 层级 | 功能 | 举例 |
|---|---|---|
| 👀 **感知翻译** | AI 把爸妈的日常写成温暖的生活明信片 | "妈妈今天喝粥，吃得清淡" |
| 🫂 **托管照护** | 主动发现需求，替子女操心 | "降压药还剩 4 天了，要不要帮她补？" |
| 🚀 **履约闭环** | 一键转美团本地生活，办完告诉你 | 子女点一下 → 同仁堂送药上门 → "你帮了她" |

**一句话：不是监控，不是报警。是一张会替你开口、替你操心、替你办到的明信片。**

### 为什么是美团

把"妈妈的降压药快吃完了"在今天变成"同仁堂大药房已送达"——这张本地履约网，目前只有美团真正跑通：

- 🏪 医药即时零售份额超 70%，覆盖 25 万家药店
- 🛵 即时配送 + 外卖到家 + 家政上门
- 🤖 小团 AI 助手入口，不需下载新 App
...
|---|---|---|
| 基础版 | ¥99 | 想先试试的家庭 |
| **关怀版（核心）** | **¥299** | 含上门建档 + 明信片 + 电话关怀 |
| 生活版 | ¥699 | + 上门探访 · 助洁 · 跑腿 |
| 照护版 | ¥1,299 起 | + 陪诊 · 复诊管理 |

> 即使顶配照护版，也仅为一线城市住家保姆费用的 **15–25%**。明信片不是替代保姆——是以 **1/10 的成本，解决 80% 的焦虑**。

### 与监控/手环/保姆的本质区别

- ❌ **不是监控**：妈妈主动授权，随时可关；子女看不到聊天和实时位置
- ❌ **不是报警**：不做诊断、不推荐新药，只补已有处方
- ❌ **不是替代保姆**：目标人群是"能自理但需要被看见"的空巢老人
- ✅ **是 AI 照护 + 美团履约**：24h 在线、每笔可追溯、从不请假离职

### 技术方案

- **Agent 引擎**：OpenClaw Agent 串联 3 个 Skill（life-postcard → nearby-care → service-booking）
- **信任地基**：评估师上门建档 + 本人签字授权 → AI 才能学习
- **数据诚实**：四级标签（mock / fallback / real_api 未接入 / simulated），大方写在屏幕上
